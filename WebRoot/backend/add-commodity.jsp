  ...
  <head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form id="addComForm" action="AdminCommodityServlet.shtml?action=addCom" method="post" enctype="multipart/form-data" class="layui-form">
		        	...
		        	<div class="layui-form-item">
			            ...
			            <button class="layui-btn add-commodity-btn" lay-filter="add" lay-submit="">增加</button></div>
        		</form>
        	</div>
        </div>
        <script>
